...
var TaskTabWebPart = /** @class */ (function (_super) {
    ...
    TaskTabWebPart.prototype.render = function () {
        //existing code
        this.domElement.innerHTML += "\n      <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].taskTab + "\">\n       <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].heading + "\" style=\"padding-bottom: 20px !important;\"> Pending submissions </div>\n        <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].container + "\">\n          <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].row + "\">\n            <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].grid1 + "\">\n            <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].img + "\"></div>\n            <h5 class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].title + "\">12</h5>\n            <h6 class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].title2 + "\">Days of pending timesheet</h6>\n            <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].ft + "\" id=\"fill-timesheet\">\n              Fill timesheet\n              <span class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].chevron + "\"></span>\n            </div>\n              <div>\n              </div>\n            </div>\n             <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].grid2 + "\">\n             <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].img2 + "\"></div>\n              <h5 class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].title + "\">\n              <span class=\"currency\">&#x20b9;</span> 25,000\n            </h5>\n            <h6 class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].title2 + "\">Amount of unreconciled expenses</h6>\n              <div>\n              <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].ft + "\">\n              Submit expenses\n              <span class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].chevron2 + "\"></span>\n            </div>\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].row + "\">\n        <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].headingPending + "\"> Pending approvals </div>\n         <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].subheading + "\">Purchased Orders</div>\n        <table class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].container + " table\">\n          <thead>\n            <tr>\n              <th scope=\"col\">Po no.</th>\n              <th scope=\"col\">Description</th>\n              <th scope=\"col\">Vendor name</th>\n              <th scope=\"col\">Vendor no.</th>\n              <th scope=\"col\">Amount</th>\n              <th scope=\"col\"></th>\n            </tr>\n          </thead>\n            <tbody id=\"spTaskListContainer\">\n               " + this._renderListAsync() + "\n            </tbody>\n        </table>\n        </div>\n          <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].subheading + "\">Invoice\n      </div>\n         <table class=\"table\" style=\"position:relative;top:-16px;\">\n          <thead>\n            <tr>\n              <th scope=\"col\">Invoice no.</th>\n              <th scope=\"col\">Po no.</th>\n              <th scope=\"col\">Description</th>\n              <th scope=\"col\">Vendor name</th>\n              <th scope=\"col\" class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].vno + "\">Vendor no.</th>\n              <th scope=\"col\">Amount</th>\n              <th scope=\"col\"></th>\n            </tr>\n          </thead>\n          <tbody id=\"spInvoiceListContainer\">\n            " + this._renderInvoiceListAsync() + "\n          </tbody>\n        </table>\n      <div class=\"" + _TaskWebPart_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].subheading + "\">Inventory (0)</div>\n       </div>";
        this._setButtonEventHandlers();
    };
    ...
    TaskTabWebPart.prototype.getLatestItemId = function (selectPoNumber) {
        ...
        return new Promise(function (resolve, reject) {
            _this.context.spHttpClient
                .get(_this.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('PurchaseOrders')/items?$select=id,PoNumber", _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_2__["SPHttpClient"].configurations.v1, {
                headers: {
    ...
    TaskTabWebPart.prototype.updatePoStatus = function (selectPoNumber) {
        ...
        this.getLatestItemId(selectPoNumber)
            ...
            return _this.context.spHttpClient.get(_this.context.pageContext.web.absoluteUrl + "/_api/web/lists/getbytitle('PurchaseOrders')/items(" + latestItemId + ")?$select=Title,Id", _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_2__["SPHttpClient"].configurations.v1, {
                headers: {
                    Accept: "application/json;odata=nometadata",
                    "odata-version": ""
                }
            ...
            console.log(item.Id);
            _this.context.spHttpClient
                .post(_this.context.pageContext.web.absoluteUrl + "/_api/web/lists(guid%27326cdbd1-840e-4ee7-be55-4019301c2126%27)/items(" + item.Id + ")", _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_2__["SPHttpClient"].configurations.v1, {
                headers: {
                    Accept: "application/json;odata=nometadata",
...
var styles = {
    taskTab: 'taskTab_a8601380',
    container: 'container_a8601380',
    grid1_b73c1c19: 'grid1_b73c1c19_a8601380',
    chevron: 'chevron_a8601380',
    chevron2: 'chevron2_a8601380',
    grid2_b73c1c19: 'grid2_b73c1c19_a8601380',
    subheading_b73c1c19: 'subheading_b73c1c19_a8601380',
    heading_b73c1c19: 'heading_b73c1c19_a8601380',
    button_b73c1c19: 'button_b73c1c19_a8601380',
    row: 'row_a8601380',
    column: 'column_a8601380',
    'ms-Grid': 'ms-Grid_a8601380',
    taskTab_bb7e768f: 'taskTab_bb7e768f_a8601380',
    subheading_bb7e768f: 'subheading_bb7e768f_a8601380',
    heading: 'heading_a8601380',
    headingPending: 'headingPending_a8601380',
    heading_bb7e768f: 'heading_bb7e768f_a8601380',
    subheading: 'subheading_a8601380',
    heading_d5fef6f0: 'heading_d5fef6f0_a8601380',
    title: 'title_a8601380',
    title2: 'title2_a8601380',
    ft: 'ft_a8601380',
    review: 'review_a8601380',
    grid1: 'grid1_a8601380',
    grid2: 'grid2_a8601380',
    img: 'img_a8601380',
    img2: 'img2_a8601380',
    heading_8e03eadd: 'heading_8e03eadd_a8601380',
    spInvoiceListContainer: 'spInvoiceListContainer_a8601380',
    button_8e03eadd: 'button_8e03eadd_a8601380',
    button: 'button_a8601380',
    label: 'label_a8601380',
    list: 'list_a8601380',
    listItem: 'listItem_a8601380',
    panel: 'panel_a8601380',
    vno: 'vno_a8601380'
};
...
module.exports = __webpack_require__.p + "1_399346e0f875ba1dd74f57cb3a0f687f.png";

/***/ }),

/***/ "./lib/webparts/task/imgs/2.png":
/*!**************************************!*\
  !*** ./lib/webparts/task/imgs/2.png ***!
  \**************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "2_ecf7ab89d155d5311924236984a5b6d5.png";
...
// module
exports.push([module.i, "@font-face{font-family:Teams Assets;src:url(https://avadheshftc.sharepoint.com/:u:/s/EmployeeConnectPrototype/EQLbWsb-BIREmvuOAMk7mSMBjJM505O7Jx4-4sXjxCZjDw?e=pEj018) format(\"woff\"),url(https://avadheshftc.sharepoint.com/:u:/s/EmployeeConnectPrototype/EbMqjEFO9ixJqZ3H152zkOsBdD3ED4JDopx_ydz_tdQMhw?e=OekPkb) format(\"woff2\");font-style:normal}.taskTab_a8601380 .container_a8601380{max-width:auto;margin:0 auto;position:relative;top:-18px}.taskTab_a8601380 .grid1_b73c1c19_a8601380{width:22%!important}.taskTab_a8601380 .chevron2_a8601380,.taskTab_a8601380 .chevron_a8601380{float:left;display:-webkit-box;display:-ms-flexbox;display:flex;position:absolute;z-index:1;margin-left:28%}.taskTab_a8601380 .chevron2_a8601380:before,.taskTab_a8601380 .chevron_a8601380:before{content:\"\\E449\";font-family:Teams Assets;font-size:16px;font-weight:600;color:#8595d3;margin-top:-130%;cursor:pointer}.taskTab_a8601380 .chevron2_a8601380{margin-left:35%}.taskTab_a8601380 .grid2_b73c1c19_a8601380{width:22%!important}.taskTab_a8601380 .subheading_b73c1c19_a8601380{margin:10px}.taskTab_a8601380 .heading_b73c1c19_a8601380{margin-top:20px}.taskTab_a8601380 thead{background:#f8f8f8}.taskTab_a8601380 th{font-weight:500;font-size:13px}.taskTab_a8601380 td{font-size:11px;font-weight:400;color:#333}.taskTab_a8601380 a.button_b73c1c19_a8601380{background:0 0!important;color:#3b8ce3!important}.taskTab_a8601380 .row_a8601380{margin:0 -8px;-webkit-box-sizing:border-box;box-sizing:border-box;color:\"[theme:white, default: #ffffff]\";padding:0!important;margin:4px 0!important}.taskTab_a8601380 .row_a8601380:after,.taskTab_a8601380 .row_a8601380:before{display:table;content:\"\";line-height:0}.taskTab_a8601380 .row_a8601380:after{clear:both}.taskTab_a8601380 .column_a8601380{position:relative;min-height:1px;padding-left:8px;padding-right:8px;-webkit-box-sizing:border-box;box-sizing:border-box;width:100%}[dir=ltr] .taskTab_a8601380 .column_a8601380{float:left}[dir=rtl] .taskTab_a8601380 .column_a8601380{float:right}.taskTab_a8601380 .column_a8601380 .ms-Grid_a8601380{padding:0}@media (min-width:640px){.taskTab_a8601380 .column_a8601380{width:25%}}@media (min-width:1024px){[dir=ltr] .taskTab_a8601380 .column_a8601380{left:16.66667%}[dir=rtl] .taskTab_a8601380 .column_a8601380{right:16.66667%}}@media (min-width:640px){[dir=ltr] .taskTab_a8601380 .column_a8601380{left:8.33333%}[dir=rtl] .taskTab_a8601380 .column_a8601380{right:8.33333%}}.taskTab_a8601380 .taskTab_bb7e768f_a8601380 .subheading_bb7e768f_a8601380{font-size:13px;color:gray;cursor:pointer}.taskTab_a8601380 .heading_a8601380{font-size:22px;color:#000}.taskTab_a8601380 .headingPending_a8601380{font-size:22px;margin-top:25px;color:#000}.taskTab_a8601380 .taskTab_bb7e768f_a8601380 .heading_bb7e768f_a8601380{font-size:18px;font-weight:500;padding-bottom:5px;padding-top:0}.taskTab_a8601380 .subheading_a8601380{font-size:13px;color:gray;cursor:pointer;margin-top:8px}.taskTab_a8601380 .heading_d5fef6f0_a8601380{margin-bottom:30px!important}.taskTab_a8601380 .title_a8601380{color:#000;font-size:medium;font-weight:700;padding:2px;position:relative;top:10px;display:inline}.taskTab_a8601380 .title2_a8601380{color:#000;font-weight:700;position:relative;margin-top:5%;margin-left:20%;font-size:medium}.taskTab_a8601380 .ft_a8601380{color:#8586bb;margin:10% 0 0 19%;cursor:pointer}.taskTab_a8601380 .review_a8601380{color:#0078d4;cursor:pointer}.taskTab_a8601380 .review_a8601380:hover{text-decoration:underline}.taskTab_a8601380 .grid1_a8601380,.taskTab_a8601380 .grid2_a8601380{position:relative;min-height:1px;padding-left:8px;padding-right:8px;-webkit-box-sizing:border-box;box-sizing:border-box;width:100%;padding:1.25rem;left:0!important;height:160px;width:350px;-webkit-box-shadow:0 2px 4px 0 rgba(0,0,0,.2),0 25px 50px 0 rgba(0,0,0,.1);box-shadow:0 2px 4px 0 rgba(0,0,0,.2),0 25px 50px 0 rgba(0,0,0,.1)}[dir=ltr] .taskTab_a8601380 .grid1_a8601380,[dir=ltr] .taskTab_a8601380 .grid2_a8601380{float:left}[dir=rtl] .taskTab_a8601380 .grid1_a8601380,[dir=rtl] .taskTab_a8601380 .grid2_a8601380{float:right}.taskTab_a8601380 .grid1_a8601380 .ms-Grid_a8601380,.taskTab_a8601380 .grid2_a8601380 .ms-Grid_a8601380{padding:0}@media (min-width:640px){.taskTab_a8601380 .grid1_a8601380,.taskTab_a8601380 .grid2_a8601380{width:25%}}@media (min-width:1024px){[dir=ltr] .taskTab_a8601380 .grid1_a8601380,[dir=ltr] .taskTab_a8601380 .grid2_a8601380{left:16.66667%}[dir=rtl] .taskTab_a8601380 .grid1_a8601380,[dir=rtl] .taskTab_a8601380 .grid2_a8601380{right:16.66667%}}@media (min-width:640px){[dir=ltr] .taskTab_a8601380 .grid1_a8601380,[dir=ltr] .taskTab_a8601380 .grid2_a8601380{left:8.33333%}[dir=rtl] .taskTab_a8601380 .grid1_a8601380,[dir=rtl] .taskTab_a8601380 .grid2_a8601380{right:8.33333%}}.taskTab_a8601380 .grid2_a8601380{margin-left:2%}.taskTab_a8601380 .img2_a8601380,.taskTab_a8601380 .img_a8601380{content:url(" + escape(__webpack_require__(/*! ./imgs/1.png */ "./lib/webparts/task/imgs/1.png")) + ");height:55px;width:60px;border-radius:50%;float:left}.taskTab_a8601380 .img2_a8601380{content:url(" + escape(__webpack_require__(/*! ./imgs/2.png */ "./lib/webparts/task/imgs/2.png")) + ")}.taskTab_a8601380 td,.taskTab_a8601380 th{border-left:none!important;border-right:none!important;color:#000}.taskTab_a8601380 .heading_8e03eadd_a8601380{margin-top:25px!important;padding-bottom:5px}.taskTab_a8601380 tbody#spInvoiceListContainer_a8601380{position:relative}.taskTab_a8601380 .button_a8601380,.taskTab_a8601380 a.button_8e03eadd_a8601380{background:0 0!important;color:#0078d4!important}.taskTab_a8601380 .button_a8601380{text-decoration:none;height:32px;min-width:80px;border-color:\"[theme:themePrimary, default: #0078d4]\";outline:transparent;position:relative;font-family:Segoe UI WestEuropean,Segoe UI,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,sans-serif;-webkit-font-smoothing:antialiased;font-size:14px;font-weight:400;border-width:0;text-align:center;cursor:pointer;margin-top:104px;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.taskTab_a8601380 .button_a8601380 .label_a8601380{font-weight:600;font-size:14px;height:32px;line-height:32px;font-family:Segoe UI;margin:0 4px;vertical-align:top;display:inline-block}.taskTab_a8601380 .list_a8601380{margin:10;padding:10;line-height:50px;list-style-type:none;-webkit-box-shadow:0 4px 4px 0 rgba(0,0,0,.2),0 25px 50px 0 rgba(0,0,0,.1);box-shadow:0 4px 4px 0 rgba(0,0,0,.2),0 25px 50px 0 rgba(0,0,0,.1)}.taskTab_a8601380 .list_a8601380,.taskTab_a8601380 .listItem_a8601380{color:#333;font-family:Segoe UI Regular WestEuropean,Segoe UI,Tahoma,Arial,sans-serif;font-size:14px;font-weight:400;-webkit-box-sizing:border-box;box-sizing:border-box}.taskTab_a8601380 .listItem_a8601380{vertical-align:center;margin:0;padding:0;-webkit-box-shadow:none;box-shadow:none;padding:9px 28px 3px;position:relative}.taskTab_a8601380 .panel_a8601380{padding:10px 0;background-color:#fff;border-bottom:1px solid #e8e4e4}@media (max-width:425px){.taskTab_a8601380 .grid1_a8601380,.taskTab_a8601380 .grid2_a8601380{width:100%!important;height:130px;font-size:small}.taskTab_a8601380 .grid2_a8601380{margin-top:4%;margin-left:0!important}.taskTab_a8601380 .subheading_a8601380,.taskTab_a8601380 thead th{font-size:xx-small}.taskTab_a8601380 .chevron2_a8601380,.taskTab_a8601380 .chevron_a8601380,.taskTab_a8601380 .vno_a8601380{display:none}.taskTab_a8601380 .ft_a8601380{margin:5% 0 0 19%}.taskTab_a8601380 td,.taskTab_a8601380 th{padding:.5rem!important}}", ""]);
