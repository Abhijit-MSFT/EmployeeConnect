...
var TaskTabWebPart = /** @class */ (function (_super) {
    ...
    TaskTabWebPart.prototype.updatePoStatus = function (updateObj) {
        ...
        this.getLatestItemId()
            ...
            console.log(body);
            _this.context.spHttpClient
                .post(_this.context.pageContext.web.absoluteUrl + "/_api/web/lists(guid%27326cdbd1-840e-4ee7-be55-4019301c2126%27)/items(" + latestItemId + ")", _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_2__["SPHttpClient"].configurations.v1, {
                headers: {
                    Accept: "application/json;odata=nometadata",
