...
`;
      ...
      <div class="${styles.taskTab}">
       <div class="${styles.heading}"> Pending Submissions </div>
        ...
        <div class="${styles.heading}"> Pending Approvals </div>
         <div class="${styles.subheading}">Purchased Order (5)</div>
        <table class="${styles.tableGrid} table table-bordered">
          ...
          <div class="${styles.subheading}">Invoice (3)
      </div>
    ...
    return new Promise<number>(
      (
        ...
        this.context.spHttpClient
          .get(
            `${this.context.pageContext.web.absoluteUrl}/_api/web/lists/getbytitle('TaskList')/items?$orderby=Id desc&$top=1&$select=id`,
            SPHttpClient.configurations.v1,
            {
              headers: {
  ...
  private UpdateListItem() {
    ...
    this.context.spHttpClient.get(
      `${this.context.pageContext.web.absoluteUrl}/_api/web/lists/getbytitle("TaskList")/items(848930)`,
      SPHttpClient.configurations.v1,
      {
        headers: {
      ...
      .then(
        (itemId: number): Promise<SPHttpClientResponse> => {
          ...
          return this.context.spHttpClient.get(
            `${this.context.pageContext.web.absoluteUrl}/_api/web/lists/getbytitle('TaskList')/items(${latestItemId})?$select=Id`,
            SPHttpClient.configurations.v1,
            {
              headers: {
                Accept: "application/json;odata=nometadata",
      ...
      .then(
        (item: ISPTaskList): Promise<SPHttpClientResponse> => {
          ...
          return this.context.spHttpClient.post(
            `${this.context.pageContext.web.absoluteUrl}/_api/web/lists/getbytitle('TaskList')/items(${latestItemId})`,
            SPHttpClient.configurations.v1,
            {
              headers: {
                Accept: "application/json;odata=nometadata",
